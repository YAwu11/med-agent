...
Usage::
    ...
    from app.core.checkpointer.provider import get_checkpointer, checkpointer_context
...
from app.core.config.checkpointer_config import CheckpointerConfig
from app.core.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from app.core.config.app_config import _app_config
    from app.core.config.checkpointer_config import get_checkpointer_config
